...
# Set XPDR Squawk Code

Sets the transponder squawk code value
...
| 1    | 38    | 1    | BIN  | Set XPDR Squawk Code instruction code   |
| 2    | X     | 1    | BIN  | 1st digit                               |
| 3    | X     | 1    | BIN  | 2nd digit                               |
| 4    | X     | 1    | BIN  | 3rd digit                               |
| 5    | X     | 1    | BIN  | 4th digit                               |
...
| Instrument | Squawk Code |
|------------|---------------------|
| XPDR       | 0000                |

## Examples

### Set XPDR maximum value to 2336:
